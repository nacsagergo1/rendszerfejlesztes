...
--
-- Host: localhost:3306
-- Generation Time: Oct 18, 2024 at 01:45 PM
...
--
CREATE DATABASE IF NOT EXISTS `projectg_Asztafoglalos` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci;
USE `projectg_Asztafoglalos`;
